...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    @objc func handleButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        if sender.restorationIdentifier! == "like"
        {
        ...
        else if sender.restorationIdentifier! == "comment"
        {
            
            let commentView = self.storyboard!.instantiateViewController(withIdentifier: "CommentView") as! CommentViewController
            
            commentView.postId = postData.id
            commentView.commentAuthor = Auth.auth().currentUser?.displayName
